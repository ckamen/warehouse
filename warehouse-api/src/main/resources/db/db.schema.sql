...
(
  ...
  supplier_id int DEFAULT -1 COMMENT '供应商ID',
	unit_id int DEFAULT -1 COMMENT '单位ID',
	preferred_warehouse_id int DEFAULT -1 COMMENT '首选仓库ID',
	parameter varchar(1000) DEFAULT '' COMMENT '参数',
  device varchar(1000) DEFAULT '' COMMENT '适用装置',
	active tinyint DEFAULT 1 COMMENT '是否启用,1-启用;0-不启用',
	remark varchar(200) DEFAULT '' COMMENT '备注',
  created_by int DEFAULT -1 NOT NULL COMMENT '创建人',
  created_time datetime  COMMENT '创建时间',
...
(
	...
	price float(10,2) DEFAULT 0 COMMENT '单位价格',
	min_inventory int DEFAULT -1 COMMENT '最低库存',
	max_inventory int DEFAULT -1 COMMENT '最高库存',
	inventory int DEFAULT -1 COMMENT '库存',
	rack_code varchar(6) DEFAULT '' COMMENT '货架编号',
	layer_num int DEFAULT -1 COMMENT '货架层',
	place_num int DEFAULT -1 COMMENT '位置',
...
(
	...
	code varchar(100) DEFAULT '' NOT NULL COMMENT '编码',
	name varchar(100) DEFAULT '' NOT NULL COMMENT '名称',
  rack_num smallint default 0 not null COMMENT '货架数量',
